...
const char *keywords[] = {"int", "char", "bool", "float", "double", "for", "while", "do", "if", "else", "return", "printf", "scanf", "#include<stdio.h>", "main"};
int num_keywords = sizeof(keywords) / sizeof(keywords[0]);

// Function to check if a word is an C keyword
